...
import org.usfirst.frc5112.Robot2017V3.commands.TargetingCommands.GetBoilerAngle;
...
public class OI {
	...
	public OI() {
		...
		xbox.A.whenPressed(new BoilerCameraEnable());
		xbox.B.whenPressed(new PegCameraEnable());
		xbox.START.whenPressed(new GetBoilerAngle());
	}
	//// CREATING BUTTONS
